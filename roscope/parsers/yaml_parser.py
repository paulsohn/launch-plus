...
# Originally from:
# - https://github.com/ros2/launch/blob/rolling/launch_yaml/launch_yaml/parser.py
# - https://github.com/ros2/launch/blob/rolling/launch_yaml/launch_yaml/entity.py
